...
%
% If processor is slow, can decrease ni, nj, tmax. 
% Very little viscous diffusion allowed, boundary conditions aren't great. 
% Initial condition is a sudden column of water that drops into the ocean. 
% provides a cool visualization of tsunami traveling up a beach, peaking, and returning to sea.
% 
% Download from:
%  Steve McHale (2020). Shallow Water Wave CFD (Tsunami Modelling) 
