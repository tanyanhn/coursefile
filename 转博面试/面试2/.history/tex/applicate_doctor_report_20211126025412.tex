...
\begin{frame}
    \frametitle{涉密项目}
    \begin{itemize}
        \item QT湍流尾迹的海洋表面特征等内波现象的研究, 用于QT追踪和隐身
              (\textcolor{red}{JKW
                  %   军科委
                  基础加强重点项目}).
              \begin{figure}
                  \includegraphics[width = 0.7\textwidth]{fig/s12.png}
                  \caption{水下Q T产生的各种尾迹示意图, 包括开尔文尾迹, 内波, 湍流尾迹, 涡尾迹, 煎
                      饼旋涡.}
              \end{figure}
    \end{itemize}
\end{frame}
...
\begin{frame}
    \frametitle{对涉密项目支撑的非涉密研究---殷集}
    \begin{itemize}
        \item 多相流中的几何和拓扑问题是涉密军工项目的一个核心问题
