...
\begin{frame}
  ...
  从而实现对潜艇的追踪和反追踪.我的主要工作在对动边界的追踪和
  拓扑和几何性质的提取上.
\end{frame}
...
\begin{frame}
  ...
  核心工具.所以殷集和布尔代数是用几何和拓扑的手段解决界面追踪问题,是我们
  研究潜艇项目中至关重要的一步.
\end{frame}

\begin{frame}
  说了这么多还没说殷集是什么,我们定义殷集是空间中边界有界的半解析开集.
...
\begin{frame}
  ...
  我们可以看出我们的殷集表示方法可以直接得到有两个连通分量,没有洞和
  非流行点位置等拓扑信息
\end{frame}
% % Motivation
% \section{个人基本情况介绍}
