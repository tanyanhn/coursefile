...
\begin{frame}
    ...
    \begin{figure}[!htb]
        \centering
          \subfigure[$\mathcal{Y}_1$]{\includegraphics[width=0.365\textwidth]{fig/s3.png}}
\subfigure[$\mathcal{Y}_2$]{\includegraphics[width=0.4\textwidth]{fig/s4.png}}
          \caption{$\mathcal{Y}_1$和$\mathcal{Y}_2$之间布尔运算的示例}
        %   \vspace{0.2in}
      \end{figure}
\end{frame}
