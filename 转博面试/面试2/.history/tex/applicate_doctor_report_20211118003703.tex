...
\begin{frame}
    ...
    \begin{figure}[!htb]
        \centering
          \subfigure[殷集$\mathcal{Y}$]{\includegraphics[width=0.4\textwidth]{fig/s1.png}}
...
\begin{frame}
    ...
    \begin{figure}[!htb]
        \centering
          \subfigure[殷集$\mathcal{Y}_1$]{\includegraphics[width=0.365\textwidth]{fig/s3.png}}
...
\begin{frame}
    ...
    \begin{figure}[!htb]
        \centering
\subfigure[$\partial\mathcal{Y}_1$剪开得到的部分曲面
片]{\includegraphics[width=0.35\textwidth]{fig/s16.png}} \qquad
\subfigure[$\partial\mathcal{Y}_2$剪开得到的曲面片]{\includegraphics[width=0.36\textwidth]{fig/s17.png}}
        %   \caption{sfd}
        %   \vspace{0.2in}
      \end{figure}
      \begin{figure}[!htb]
        \centering
          \subfigure[求交得到的殷集$\mathcal{Y}_3$]{\includegraphics[width=0.35\textwidth]{fig/s5.png}}
\subfigure[构成$\partial\mathcal{Y}_3$的两个黏合紧曲面]{\includegraphics[width=0.36\textwidth]{fig/s6.png}}
        %   \caption{sfd}
        %   \vspace{0.2in}
      \end{figure}
\end{frame}
