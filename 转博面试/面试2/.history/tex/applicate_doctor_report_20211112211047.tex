...
\begin{frame}
    \frametitle{团队已有的成果}
    \begin{itemize}
        \item 在二维空间中提出了殷集的定义(MATH COMP, 2020)
...
\begin{frame}
    \frametitle{论文在投}
    \includegraphics[width = \textwidth]{fig/SIAM.png}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \begin{center}
            ...
            \includegraphics[width = 0.7\textwidth]{fig/fig/Mars};
            % \animategraphics[autoplay,
            %                 loop,
            %                 width=.7\textwidth]{5}{fig/fig/000}{1}{17}	
        \end{center}
        \item 因为现有方法不能精确捕捉和刻画拓扑变化.
        \item 我们期望通过结合殷集建模,在张庆海教授论文(SIAM J SCI COMP, 2018)中提出的CubicMARS方法上
        新增对拓扑变化的处理,并且高精度捕捉拓扑变化的时间点和位置.
        \item 这个研究对我们团队的国防项目是核心部分.
    \end{itemize}
\end{frame}
